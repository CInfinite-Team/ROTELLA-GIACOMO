          ...
          >
            ...
            <div className="flex items-center flex-wrap gap- justify-between py-[6px]  px-3">
              ...
              >
                ...
                <span className="text-sm font-medium">
                  ...
                  <br />- No Commitment, Cancel at any time
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 mt-8 px-2">
              ...
              <div
                ...
                ref={useViewportAnimation({
                  animationClass: "animate-in stagger-5",
                  once: false,
                })}
              >
                <div className="w-fit h-fit ">
                  <div className="relative translate-x-16 xl:translate-x-11 w-fit h-fit">
                    <img
                      ...
                      loading="lazy"
                      decoding="async"
                      className="rounded-full w-[70%] xl:w-[80%] aspect-square object-cover"
                    />
                    ...
                    <div className="flex items-center  text-center">
                      ...
                      <span className="text-lg font-semibold pl-2 2xl:text-3xl text-white">
            ...
            <div
              ...
              ref={useViewportAnimation({
                animationClass: "animate-in stagger-6",
                once: false,
              })}
            >
