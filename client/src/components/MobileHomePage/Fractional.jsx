  ...
  return (
    <div className="flex flex-col bg-[#f5f5f5]  gap-5 min-h-[80vh] lg:min-h-[100vh]  items-center justify-center">
      <div className="w-full ">
        <h2
          className="font-bold whitespace-nowrap slide-up stagger-1  text-center lg:text-left !leading-tight "
      ...
      <div className="w-full hidden xl:block">
        <p
          className=" whitespace-nowrap font-semibold text-center lg:text-left  slide-up stagger-2 text-[#981818] 2xl:mt-4 "
          ref={useViewportAnimation()}
        ...
        {t("fractional_desc_part5", { defaultValue: "" }) && (
          <p
            className=" whitespace-normal lg:max-w-[88%] xl:max-w-[70%] font-semibold text-center lg:text-left slide-up stagger-2 text-[#981818] 2xl:mt-4 "
            ref={part5Ref}
            style={{ fontSize: "clamp(12px, 2vw, 40px)" }}
          >
      ...
      <div className="w-full xl:hidden">
        <p
          className="  font-semibold text-center lg:text-left  slide-up stagger-2 text-[#981818] 2xl:mt-4 "
          ref={useViewportAnimation()}
