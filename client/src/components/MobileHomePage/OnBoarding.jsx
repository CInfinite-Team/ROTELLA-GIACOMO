...
function OnBoarding() {
  return (
    <div className='flex bg-[#eae0d5]  flex-col min-h-screen items-center justify-center gap-4 md:gap-10'>
       <h2 className=' text-center font-bold mt-10 fade-in' ref={useViewportAnimation()}
       style={{ fontSize: "clamp(25px, 8vw, 57px)" }}>
                ...
                <ol className='text-center space-y-1 font-medium mb-10'>
                  <li className=' font-semibold slide-left' ref={useViewportAnimation()}
                  ...
                  <li className=' font-semibold slide-right' ref={useViewportAnimation()}
                   style={{ fontSize: "clamp(16px, 5.5vw, 30px)" }}>
