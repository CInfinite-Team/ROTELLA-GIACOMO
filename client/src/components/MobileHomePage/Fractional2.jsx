...
const Fractional2 = React.memo(function Fractional2({
  ...
  return (
    <div className="relative bg-[#f5f5f5]  z-1 min-h-[80vh] lg:min-h-[100vh] flex flex-col gap-5 md:gap-8 items-center justify-center">
      <p
        className="font-bold whitespace-nowrap w-full text-center lg:text-left text-4xl md:text-4xl  slide-up stagger-1 !leading-tight "
      ...
      <p
        className=" w-full xl:block hidden font-semibold whitespace-nowrap text-center lg:text-left text-[#181818] slide-up stagger-2"
        ref={useViewportAnimation()}
        style={{ fontSize: "clamp(14px, 2.5vw, 40px)" }}
      >
        <Trans
          i18nKey="fractional2_desc_full"
          t={t}
          components={{
      ...
      <p
        className=" xl:hidden w-full font-semibold  text-center lg:text-left text-[#181818] slide-up stagger-2"
        ref={useViewportAnimation()}
        style={{ fontSize: "clamp(20px, 2.5vw, 40px)" }}
      >
        <Trans
          i18nKey="fractional2_desc_mobile"
          t={t}
          components={{
            1: <Highlight className=" text-white leading-tight " />,
          }}
