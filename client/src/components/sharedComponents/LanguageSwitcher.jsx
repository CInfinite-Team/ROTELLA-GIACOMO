...
const LanguageSwitcher = () => {
    ...
    return (
        <div className="fixed bottom-24 lg:bottom-6 right-6 z-[9999] flex flex-col items-end gap-2">
            <AnimatePresence>
             {isOpen && (
                <motion.div
            ...
            <button
                ...
                className={`flex items-center justify-center w-10 h-10 text-xs font-bold transition-all duration-300 rounded-full shadow-2xl tracking-wider
