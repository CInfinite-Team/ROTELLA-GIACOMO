        ...
        <div className="fixed bottom-24 lg:bottom-6 right-6 z-50 flex flex-col items-end gap-3">
            ...
            >
             ...
             <a
                ...
                className="flex items-center justify-center w-12 h-12 bg-[#000000] text-white rounded-full shadow-2xl hover:scale-110 active:scale-95 transition-all duration-300 border border-white/20"
